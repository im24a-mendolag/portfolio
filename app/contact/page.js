...
const hasContactLinks = Boolean(
  contactInfo.email || contactInfo.github || contactInfo.linkedin || contactInfo.leetcode
);
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div
          className={`grid grid-cols-1 gap-12 ${
            contactInfo.email && hasContactLinks ? 'lg:grid-cols-2' : ''
          }`}
        >
          {/* Contact Form */}
          {contactInfo.email && (
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={isSubmitting}
                    className="w-full bg-white/5 border border-white/20 px-4 py-3 rounded-md text-white focus:outline-none focus:border-white/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    placeholder={contactInfo.email || 'you@example.com'}
                  />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a
                        ...
                        className="text-gray-300 hover:text-white transition-colors break-words break-all"
                      >
                        {contactInfo.email}
                      </a>
                    </div>
